...
Describe -tag 'PSPetstoreDemo' -name 'PetApi' {
    Context 'Add-Pet' {
        It 'Test Add-Pet' {
            $Pet = (Initialize-Pet -Id 333 -Category (Initialize-Category -Id 333 -Name "Name_test") -Name "Name_test" -PhotoUrls @("PhotoUrls_example_test") -Tags @((Initialize-Tag -Id 333 -Name "Name_test")) -Status "available") # Pet | Pet object that needs to be added to the store
            Add-Pet -Pet $Pet
