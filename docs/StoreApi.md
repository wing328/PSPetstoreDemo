# petstore.petstore/Api.StoreApi

All URIs are relative to *http://petstore.swagger.io:80/v2*

Method | HTTP request | Description
------------- | ------------- | -------------
[**Invoke-DeleteOrder**](StoreApi.md#Invoke-DeleteOrder) | **DELETE** /store/order/{order_id} | Delete purchase order by ID
[**Get-Inventory**](StoreApi.md#Get-Inventory) | **GET** /store/inventory | Returns pet inventories by status
[**Get-OrderById**](StoreApi.md#Get-OrderById) | **GET** /store/order/{order_id} | Find purchase order by ID
...
try {
    ...
    Write-Host ("Exception occurred when calling Get-Inventory: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
try {
    ...
    Write-Host ("Exception occurred when calling Invoke-PlaceOrder: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
