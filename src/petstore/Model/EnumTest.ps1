...
function Initialize-EnumTest {
    ...
    Process {
        'Creating PSCustomObject: petstore => EnumTest' | Write-Debug
...
EnumTest<PSCustomObject>
#>
function ConvertFrom-JsonToEnumTest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: petstore => EnumTest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json
        $EnumTestAdditionalProperties = @{}

        # check if Json contains properties not defined in EnumTest
        $AllProperties = ("enum_string", "enum_string_required", "enum_integer", "enum_number", "outerEnum", "outerEnumInteger", "outerEnumDefaultValue", "outerEnumIntegerDefaultValue")
        foreach ($name in $JsonParameters.PsObject.Properties.Name) {
            # store undefined properties in additionalProperties
            if (!($AllProperties.Contains($name))) {
                $EnumTestAdditionalProperties[$name] = $JsonParameters.PSobject.Properties[$name].value
            }
        }
        ...
        $PSO = [PSCustomObject]@{
            ...
            "outerEnumDefaultValue" = ${OuterEnumDefaultValue}
            "outerEnumIntegerDefaultValue" = ${OuterEnumIntegerDefaultValue}
            "AdditionalProperties" = $EnumTestAdditionalProperties
        }
