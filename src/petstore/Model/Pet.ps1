...
function Initialize-Pet {
    ...
    Process {
        'Creating PSCustomObject: petstore => Pet' | Write-Debug
...
function ConvertFrom-JsonToPet {
    ...
    Process {
        'Converting JSON to PSCustomObject: petstore => Pet' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json
        $PetAdditionalProperties = @{}
        ...
        foreach ($name in $JsonParameters.PsObject.Properties.Name) {
            ...
            if (!($AllProperties.Contains($name))) {
                $PetAdditionalProperties[$name] = $JsonParameters.PSobject.Properties[$name].value
            }
        }
        ...
        $PSO = [PSCustomObject]@{
            ...
            "tags" = ${Tags}
            "status" = ${Status}
            "AdditionalProperties" = $PetAdditionalProperties
        }
