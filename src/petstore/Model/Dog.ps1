...
function Initialize-Dog {
    ...
    Process {
        'Creating PSCustomObject: petstore => Dog' | Write-Debug
...
Dog<PSCustomObject>
#>
function ConvertFrom-JsonToDog {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: petstore => Dog' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json
        $DogAdditionalProperties = @{}

        # check if Json contains properties not defined in Dog
        $AllProperties = ("className", "color", "breed")
        foreach ($name in $JsonParameters.PsObject.Properties.Name) {
            # store undefined properties in additionalProperties
            if (!($AllProperties.Contains($name))) {
                $DogAdditionalProperties[$name] = $JsonParameters.PSobject.Properties[$name].value
            }
        }
        ...
        $PSO = [PSCustomObject]@{
            ...
            "color" = ${Color}
            "breed" = ${Breed}
            "AdditionalProperties" = $DogAdditionalProperties
        }
