...
function Initialize-FormatTest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: petstore => FormatTest' | Write-Debug
...
FormatTest<PSCustomObject>
#>
function ConvertFrom-JsonToFormatTest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: petstore => FormatTest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json
        $FormatTestAdditionalProperties = @{}

        # check if Json contains properties not defined in FormatTest
        $AllProperties = ("integer", "int32", "int64", "number", "float", "double", "string", "byte", "binary", "date", "dateTime", "uuid", "password", "pattern_with_digits", "pattern_with_digits_and_delimiter")
        foreach ($name in $JsonParameters.PsObject.Properties.Name) {
            # store undefined properties in additionalProperties
            if (!($AllProperties.Contains($name))) {
                $FormatTestAdditionalProperties[$name] = $JsonParameters.PSobject.Properties[$name].value
            }
        }
        ...
        $PSO = [PSCustomObject]@{
            ...
            "pattern_with_digits" = ${PatternWithDigits}
            "pattern_with_digits_and_delimiter" = ${PatternWithDigitsAndDelimiter}
            "AdditionalProperties" = $FormatTestAdditionalProperties
        }
