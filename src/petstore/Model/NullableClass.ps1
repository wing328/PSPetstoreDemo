...
function Initialize-NullableClass {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: petstore => NullableClass' | Write-Debug
...
NullableClass<PSCustomObject>
#>
function ConvertFrom-JsonToNullableClass {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: petstore => NullableClass' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NullableClass
