...
function Initialize-Capitalization {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: petstore => Capitalization' | Write-Debug
...
Capitalization<PSCustomObject>
#>
function ConvertFrom-JsonToCapitalization {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: petstore => Capitalization' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json
        $CapitalizationAdditionalProperties = @{}

        # check if Json contains properties not defined in Capitalization
        $AllProperties = ("smallCamel", "CapitalCamel", "small_Snake", "Capital_Snake", "SCA_ETH_Flow_Points", "ATT_NAME")
        foreach ($name in $JsonParameters.PsObject.Properties.Name) {
            # store undefined properties in additionalProperties
            if (!($AllProperties.Contains($name))) {
                $CapitalizationAdditionalProperties[$name] = $JsonParameters.PSobject.Properties[$name].value
            }
        }
        ...
        $PSO = [PSCustomObject]@{
            ...
            "SCA_ETH_Flow_Points" = ${SCAETHFlowPoints}
            "ATT_NAME" = ${ATTNAME}
            "AdditionalProperties" = $CapitalizationAdditionalProperties
        }
